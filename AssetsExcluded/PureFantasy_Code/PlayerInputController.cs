...
public class PlayerInputController : MonoBehaviour {
    ...
    //  Initialize
    //================
    public Actor _actor; //actor reference to get the right camera to align movement
    private Transform _transform; //cache reference to Transform!
    private Camera _camera;
    private MovementController _movementController; //so it knows where to send the inputs
